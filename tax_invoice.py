...
class tax_invoiceClass:
    def __init__(self,root):
        ...
        #============Search Frame==================
        SearchFrame=LabelFrame(self.root,text="Search Tax Invoice Data",font=("helvetica",12,"bold"),bd=2,relief=RIDGE,bg="white")
        SearchFrame.place(x=10,y=20,width=750,height=70)

        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Select","T_ID","BILL_NO","DATE","CUSTOMER"),state='readonly',justify=CENTER,font=("helvetica",15))
        ...
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("helvetica",15),bg="black",fg="white",cursor="hand2").place(x=260,y=9,width=80,height=30)
                
        self.btn_export_search = Button(SearchFrame, text="Export Search to PDF", command=self.export_searched_tax_invoice_to_pdf, font=("helvetica", 12,"bold"), bg="red", fg="white",cursor="hand2")
        ...
        btn_export_excel = Button(ExportFrame, text="Export to Excel", command=self.export_to_excel, font=("helvetica", 15, "bold"), bg="yellow", fg="black", cursor="hand2")
        ...
        btn_import=Button(ExportFrame, text="Import from Excel", command=self.import_excel_to_db, font=("helvetica", 15,"bold"), bg="brown", fg="white", cursor="hand2")
        btn_import.place(x=340, y=10,width=200,height=28)
        #===========Title===================
        #title=Label(self.root,text="vendor_code_part Details",font=("helvetica",15),bg="#0f4d7d",fg="white").place(x=50,y=100,width=1000)
        #=========Clock==============
        ...
        #===========Content================
        #=========Row 1===============================================================================================
        lbl_t_id=Label(self.root,text="T ID",font=("helvetica",13),bg="white").place(x=20,y=150)
        self.txt_t_id=Entry(self.root,textvariable=self.var_t_id,justify=CENTER,state='readonly',font=("helvetica",13),bg="lightyellow",validate="key", validatecommand=vcmd)
        self.txt_t_id.place(x=130,y=150,width=80)
        
        lbl_bill_no=Label(self.root,text="Bill No",font=("helvetica",13),bg="white").place(x=240,y=150)
        self.txt_bill_no=Entry(self.root,textvariable=self.var_bill_no,justify=CENTER,font=("helvetica",13),bg="lightyellow",validate="key", validatecommand=vcmd)
        self.txt_bill_no.place(x=330,y=150,width=110)
        
        lbl_date=Label(self.root,text="Date",font=("helvetica",13),bg="white").place(x=460,y=150)
        # Date picker widget
        txt_date = DateEntry(self.root,textvariable=self.var_date,justify=CENTER,font=("helvetica", 12),bg="lightyellow",date_pattern="dd-mm-yyyy")  # Set the format to dd/mm/yyyy
        ...
        lbl_customer=Label(self.root,text="Customer",font=("helvetica",13),bg="white").place(x=700,y=150)
        #txt_customer=Entry(self.root,textvariable=self.var_customer,justify=CENTER,font=("helvetica",12),bg="lightyellow").place(x=420,y=150,width=110)
        cmb_customer=ttk.Combobox(self.root,textvariable=self.var_customer,values=self.customer_list,state='readonly',justify=CENTER,font=("helvetica",12))
        cmb_customer.place(x=870,y=150,width=90)
        cmb_customer.current(0)        
        
        lbl_service_name=Label(self.root,text="Service Name",font=("helvetica",13),bg="white").place(x=970,y=150)
        self.txt_service_name=Entry(self.root,textvariable=self.var_service_name,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd)
        ...
        #===========Row 2============================================================================================
        lbl_hsn=Label(self.root,text="HSN/SAC",font=("helvetica",13),bg="white").place(x=20,y=190)
        self.txt_hsn=Entry(self.root,textvariable=self.var_hsn,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd)
        ...
        lbl_quantity=Label(self.root,text="Quantity",font=("helvetica",13),bg="white").place(x=240,y=190)
        #txt_quantity=Entry(self.root,textvariable=self.var_quantity,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd).place(x=110,y=190,width=80)
        self.txt_quantity = Entry(self.root, textvariable=self.var_quantity,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd)
        self.txt_quantity.place(x=330,y=190,width=110)
        self.txt_quantity.bind("<KeyRelease>", self.recalculate_tax_and_total)
        
        lbl_unit=Label(self.root,text="Unit",font=("helvetica",13),bg="white").place(x=460,y=190) 
        self.txt_unit=Entry(self.root,textvariable=self.var_unit,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd)
        ...
        lbl_rate=Label(self.root,text="Rate (RS)",font=("helvetica",13),bg="white").place(x=700,y=190)
        #txt_rate=Entry(self.root,textvariable=self.var_rate,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd).place(x=570,y=190,width=110)
        self.txt_rate = Entry(self.root, textvariable=self.var_rate,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd)
        self.txt_rate.place(x=870,y=190,width=90)
        self.txt_rate.bind("<KeyRelease>", self.recalculate_tax_and_total)        
        
        lbl_cgst_rate=Label(self.root,text="CGST Rate",font=("helvetica",13),bg="white").place(x=970,y=190)
        self.txt_cgst_rate = Entry(self.root, textvariable=self.var_cgst_rate,justify=CENTER,font=("helvetica", 12),bg="lightyellow",validate="key", validatecommand=vcmd)
        self.txt_cgst_rate.place(x=1140,y=190,width=80)
        self.txt_cgst_rate.bind("<KeyRelease>", self.recalculate_tax_and_total)        
        #===========Row 3============================================================================================
        lbl_cgst_amount=Label(self.root,text="CGST Amount",font=("helvetica",13),bg="white").place(x=20,y=230)
        self.txt_cgst_amount=Entry(self.root,textvariable=self.var_cgst_amount,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd)
        self.txt_cgst_amount.place(x=130,y=230,width=80)
        
        lbl_sgst_rate=Label(self.root,text="SGST Rate",font=("helvetica",13),bg="white").place(x=240,y=230)
        self.txt_sgst_rate = Entry(self.root, textvariable=self.var_sgst_rate,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd)
        self.txt_sgst_rate.place(x=330,y=230,width=110)
        self.txt_sgst_rate.bind("<KeyRelease>", self.recalculate_tax_and_total)        
        
        lbl_sgst_amount=Label(self.root,text="SGST Amount",font=("helvetica",13),bg="white").place(x=460,y=230)
        self.txt_sgst_amount=Entry(self.root,textvariable=self.var_sgst_amount,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd)
        self.txt_sgst_amount.place(x=570,y=230,width=110)
                
        lbl_amount=Label(self.root,text="Amount (RS)",font=("helvetica",13),bg="white").place(x=700,y=230)
        txt_amount=Entry(self.root,textvariable=self.var_amount,justify=CENTER,font=("helvetica",12),bg="lightyellow",validate="key", validatecommand=vcmd).place(x=870,y=230,width=90)
        #==========Buttons==================================================================================================
        ...
        tax_invoice_frame=LabelFrame(self.root,text="Tax Invoice List",font=("helvetica",12,"bold"),bd=3,relief=RIDGE,bg="white")
    ...
    def show_service_name_suggestions(self, event=None):
        ...
        if results:
            self.service_name_listbox = Listbox(self.root, height=4, bg="white", font=("helvetica", 10))
    ...
    def show_hsn_suggestions(self, event=None):
        ...
        if results:
            self.hsn_listbox = Listbox(self.root, height=4, bg="white", font=("helvetica", 10))
    ...
    def show_unit_suggestions(self, event=None):
        ...
        if results:
            self.unit_listbox = Listbox(self.root, height=4, bg="white", font=("helvetica", 10))
    ...
    def export_searched_tax_invoice_to_pdf(self):
            ...
            pdf_file = filedialog.asksaveasfilename(defaultextension=".pdf",
                                                    ...
                                                    initialfile="Search_Tax_Invoice.pdf")
            if not pdf_file:
                return
    ...
    def export_to_excel(self):
            ...
            try:
                ...
                output_file = "./data/Tax Invoice Data/Report.xlsx"
    ...
    def export_to_pdf(self):
            ...
            try:
                ...
                pdf_file = filedialog.asksaveasfilename(
                    defaultextension="./data/Tax Invoice Data/All Data.pdf",
                    filetypes=[("PDF files", "*.pdf")]
                )
                if not pdf_file:
                    return
                ...
                elements.append(Paragraph("<b>TAX INVOICE REPORT</b>", styles['Title']))
